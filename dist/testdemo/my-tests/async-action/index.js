...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(30), __webpack_require__(101)(module)))
...
exports.RECEIVE_POSTS = exports.REQUEST_POSTS = exports.INVALIIDATE_SUBREDDIT = exports.SELECT_SUBREDDIT = undefined;
...
var INVALIIDATE_SUBREDDIT = exports.INVALIIDATE_SUBREDDIT = 'INVALIIDATE_SUBREDDIT';
...
var RECEIVE_POSTS = exports.RECEIVE_POSTS = 'RECIVE_POSTS';
...
function fetchPosts(subreddit) {
    return function (dispatch) {
        ...
        return (0, _isomorphicFetch2.default)('http://127.0.0.1:3000').then(function (res) {
            return res.json();
        }, function () {
...
function selectedSubreddit() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'rectjs';
    var action = arguments[1];
    ...
    switch (action.type) {
        ...
        case _actions.RECEIVE_POSTS:
            return _extends({}, state, {
                ...
                didInvalidate: false,
                item: action.posts,
                lasteUpdated: action.receivedAt
            });
        default:
            return state;
    }
...
function postsBySubreddit() {
    ...
    switch (action.type) {
        ...
        case _actions.RECEIVE_POSTS:
        case _actions.REQUEST_POSTS:
            return _extends({}, state, _defineProperty({}, action.subreddit, posts([action.subreddit], action)));
        default:
            return state;
    }
}
...
var _deepDiff = __webpack_require__(266);
