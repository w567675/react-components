...
var _classSet = __webpack_require__(73);
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'tab' },
                _react2.default.createElement(TabBtns, this.props)
            );
        }
    }]);
...
var TabBtns = function (_Component2) {
    _inherits(TabBtns, _Component2);

    function TabBtns(props) {
        _classCallCheck(this, TabBtns);

        var _this2 = _possibleConstructorReturn(this, (TabBtns.__proto__ || Object.getPrototypeOf(TabBtns)).call(this, props));

        _this2.displayName = 'TabBtns';
        return _this2;
    }

    _createClass(TabBtns, [{
        key: 'render',
        value: function render() {
            var _this3 = this;
            ...
            deepMap.forEach(function (v, i) {
                ...
                btnList.push(_react2.default.createElement(OneTabBtn, _extends({ active: active, dataKey: i, key: i, name: v.name }, _this3.props)));
            });
...
var OneTabBtn = function (_Component3) {
    _inherits(OneTabBtn, _Component3);

    function OneTabBtn(props) {
        _classCallCheck(this, OneTabBtn);

        var _this4 = _possibleConstructorReturn(this, (OneTabBtn.__proto__ || Object.getPrototypeOf(OneTabBtn)).call(this, props));

        _this4.displayName = 'OneTabBtn';
        return _this4;
    }

    _createClass(OneTabBtn, [{
        key: 'handleClick',
...
var TabCon = function (_Component) {
    _inherits(TabCon, _Component);

    function TabCon(props) {
        _classCallCheck(this, TabCon);

        var _this = _possibleConstructorReturn(this, (TabCon.__proto__ || Object.getPrototypeOf(TabCon)).call(this, props));

        _this.displayName = 'TabCon';
        return _this;
    }
    ...
    _createClass(TabCon, [{
        ...
        value: function getItems() {
            ...
            var _props = this.props,
                index = _props.index,
                selectVal = _props.selectVal,
                valIndex = _props.valIndex,
                params = _props.params,
                addressMap = _props.addressMap;
            ...
            var cityItem = function cityItem(val) {
                var items = [];
                for (var key in val) {
                    var active = false;
                    key = parseInt(key, 10);
                    ...
                    items.push(_react2.default.createElement(CityItem, _extends({ key: ++globalkey, id: key, val: val, active: active }, _this2.props)));
                }
                return items;
            };
            ...
            for (var _key in data) {
                items.push(_react2.default.createElement(
                    'div',
                    { className: 'area-item-group', key: ++globalkey },
                    _key !== '' && _react2.default.createElement(
                        'span',
                        { className: 'area-item' },
                        _key
                    ),
...
var CityItem = function (_Component2) {
    _inherits(CityItem, _Component2);
    ...
    _createClass(CityItem, [{
        ...
        value: function handleClick() {
            var _props3 = this.props,
                index = _props3.index,
                changeState = _props3.changeState,
                id = _props3.id,
                selectVal = _props3.selectVal,
                selectName = _props3.selectName,
                valIndex = _props3.valIndex;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'span',
                { className: className, 'data-id': id, onClick: this.handleClick.bind(this) },
                ' ',
                text,
                ' '
            );
...
var _Tab = __webpack_require__(213);

var _Tab2 = _interopRequireDefault(_Tab);

var _TabCon = __webpack_require__(214);

var _TabCon2 = _interopRequireDefault(_TabCon);
...
var PostionContainer = function (_Component) {
    _inherits(PostionContainer, _Component);

    function PostionContainer(props) {
        _classCallCheck(this, PostionContainer);

        var _this = _possibleConstructorReturn(this, (PostionContainer.__proto__ || Object.getPrototypeOf(PostionContainer)).call(this, props));

        _this.displayName = 'PostionContainer';
        return _this;
    }

    _createClass(PostionContainer, [{
        key: 'handClick',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: className, style: style, onClick: this.handClick.bind(this) },
                _react2.default.createElement(_Tab2.default, this.props),
                _react2.default.createElement(_TabCon2.default, this.props)
            );
        }
    }]);
...
//# sourceMappingURL=PostionContainer.js.map